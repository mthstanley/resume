...
%OS:                     &  Unix, Mac OSX, Linux (Arch, Fedora)          \\
%Version Control:        &  Git                                          \\
%\end{tabular}
...
{
    %TODO: rewrite in a way that show progression better
    ...
    and execute catering menus for parties exceeding 100 individuals.
        ...
        %Began washing dishes, quickly garnered respect and responsibility
        %moving to line chef and baker, eventually mastering all kitchen
        %positions

        %Began washing dishes, quickly garnered respect and responsibility
        %moving to line chef and baker, eventually mastering all kitchen positions
        
        %Mastered all kitchen positions: starting from dishwasher and 
        %quickly climbing to baker and line chef 
